 ...
 * ```
 */
export var arrFind = _unwrapFunctionWithPoly("find", ArrProto, polyArrFind);
/**
 ...
 * ```
 */
export var arrFindIndex = _unwrapFunctionWithPoly("findIndex", ArrProto, polyArrFindIndex);
/**
 ...
 * ```
 */
export var arrFindLast = _unwrapFunctionWithPoly("findLast", ArrProto, polyArrFindLast);
/**
 ...
 * ```
 */
export var arrFindLastIndex = _unwrapFunctionWithPoly("findLastIndex", ArrProto, polyArrFindLastIndex);
