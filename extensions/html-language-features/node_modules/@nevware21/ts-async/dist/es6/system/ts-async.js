...
System.register('nevware21.ts-async', [], (function (exports) {
    ...
    return {
        execute: (function () {
            ...
            const createAsyncAllPromise = exports('createAsyncAllPromise', _createAllPromise(createAsyncPromise));
            const createAsyncResolvedPromise = exports('createAsyncResolvedPromise', _createResolvedPromise(createAsyncPromise));
            const createAsyncRejectedPromise = exports('createAsyncRejectedPromise', _createRejectedPromise(createAsyncPromise));
            ...
            const createSyncAllPromise = exports('createSyncAllPromise', _createAllPromise(createSyncPromise));
            const createSyncResolvedPromise = exports('createSyncResolvedPromise', _createResolvedPromise(createSyncPromise));
            const createSyncRejectedPromise = exports('createSyncRejectedPromise', _createRejectedPromise(createSyncPromise));
            ...
            const createIdleAllPromise = exports('createIdleAllPromise', _createAllPromise(createIdlePromise));
            const createIdleResolvedPromise = exports('createIdleResolvedPromise', _createResolvedPromise(createIdlePromise));
            const createIdleRejectedPromise = exports('createIdleRejectedPromise', _createRejectedPromise(createIdlePromise));
            ...
            const createAllPromise = exports('createAllPromise', _createAllPromise(createPromise));
            const createResolvedPromise = exports('createResolvedPromise', _createResolvedPromise(createPromise));
            const createRejectedPromise = exports('createRejectedPromise', _createRejectedPromise(createPromise));
